WORK_LIST = ["preface", "farnell-herodotus"]
TITLES = {"preface": "Preface", "farnell-herodotus": "Tales from Herodotus"}
...
for WORK in WORK_LIST:
    ...
    <body>
      ...
      <nav>&#x2191; <a href="./">Farnell Tales from Herodotus</a></nav>
    """
    FOOTER = """\
        <br/><br/>
        <nav>&#x2191; <a href="./">Farnell Tales from Herodotus</a></nav>
        ...
        <p>The source is available at <a href="https://github.com/FergusJPWalsh/farnell-herodotus">https://github.com/FergusJPWalsh/farnell-herodotus</a>.</p>
        </div>
    </body>
    </html>
    """
